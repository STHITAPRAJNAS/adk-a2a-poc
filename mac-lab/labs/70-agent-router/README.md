...
> **Note (Mac variant):** the Windows lab has a further optional lab 90 (real
> cloud GPUs). It's omitted here — this Mac lab has no GPU track. See
> `../../k8s-lab/labs/90-cloud-gpu/` if you want it.
